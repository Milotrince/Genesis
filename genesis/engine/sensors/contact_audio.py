...
class ContactAudioSensor(
    ...
    SimpleSensor[ContactAudioOptions, ContactAudioSensorMetadata],
):
    """
    ...
    def __init__(self, options: ContactAudioOptions, sensor_idx: int, sensor_manager: "SensorManager"):
    ...
    @classmethod
    def _update_raw_data(cls, shared_metadata: ContactAudioSensorMetadata, raw_data_T: torch.Tensor):
        sm = shared_metadata
        solver = sm.solver
