...
class SpatialAudioSensor(SimpleSensor[SpatialAudioOptions, SpatialAudioSensorMetadata]):
    """
    ...
    def __init__(self, options: SpatialAudioOptions, sensor_idx: int, sensor_manager: "SensorManager"):
    ...
    @classmethod
    def _update_raw_data(cls, shared_metadata: SpatialAudioSensorMetadata, raw_data_T: torch.Tensor):
        sm = shared_metadata
        solver = sm.solver
