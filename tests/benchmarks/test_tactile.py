...
# Imported for their side effect of making the benchmark logging fixtures resolvable in this
# module's namespace; they are defined in `test_rigid` rather than a shared conftest.
from .test_rigid import factory_logger, stream_writers  # noqa: F401
